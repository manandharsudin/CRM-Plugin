...
> Last updated: 2026-06-27 (Phase 4.1 — email infrastructure complete)
...
| 4 — Notifications & hardening | 🔄 In progress — 4.1 ✅ (2026-06-27) | 4.1 ✅: STCRM_Mailer + 5 AS email hooks + email_agent_fallback setting. Verified 2026-06-27. 4.2–4.5 pending: email templates, auto-close notice, security pass, uninstall | Reply notice lands in inbox (not spam) with working deep link; abuse attempts throttled |
